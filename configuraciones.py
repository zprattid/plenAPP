...
#Hasta el 16/07
copyTOestefania = ["la solana","tomelloso","villarrobledo","albacete","hellin","patraix valencia i","javea"]
copyTOalberto = ["santa pola","elche i","elche ii","aspe","san vicente","san juan","la nucia"]
copyTOjavier = []
